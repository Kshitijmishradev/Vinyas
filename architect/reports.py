...
def sarif_report(graph: AnalysisGraph) -> str:
    ...
    payload = {
        ...
        "version": "2.1.0",
        "runs": [{
            "tool": {"driver": {"name": "Architect Pro", "version": "1.0.0", "rules": [
...
def _sarif_result(finding: Any) -> dict[str, Any]:
    result: dict[str, Any] = {
        ...
        "partialFingerprints": {"architectFingerprint": finding.fingerprint},
    }
    if finding.path:
